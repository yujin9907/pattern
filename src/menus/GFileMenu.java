...
public class GFileMenu extends JMenu {
    ...
    private GDrawingPanel getCurrentDrawingPanel() {
        if (jTabbedPane.getSelectedComponent() instanceof GDrawingPanel currentPanel) {
            return currentPanel;
        }

        throw new RuntimeException("판넬이 존재하지 않습니다.");
    }
    ...
    public void open() throws IOException, ClassNotFoundException {
        ...
        getCurrentDrawingPanel().setShapes(objectInputStream.readObject()); // 타입 캐스트 안에 드가서 화긴

        objectInputStream.close();
    }

    // TODO try-catch 여기다가 넣어야 됨
    ...
    public boolean saveAs() {
        ...
        try {
            ...
            int returnVal = chooser.showSaveDialog(getCurrentDrawingPanel());
    ...
    public boolean close() throws IOException {
        ...
        if (getCurrentDrawingPanel().isUpdated()) {
            int reply = JOptionPane.NO_OPTION;
            reply = JOptionPane.showConfirmDialog(getCurrentDrawingPanel(), "변경내용 저장?");
